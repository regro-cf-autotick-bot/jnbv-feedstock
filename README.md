...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jnbv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13491&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jnbv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jnbv` can be installed with:

```
conda install jnbv
```

It is possible to list all of the versions of `jnbv` available on your platform with:
